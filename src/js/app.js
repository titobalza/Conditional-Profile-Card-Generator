...
function render(variables = {}) {
  ...
  linkedinInput.addEventListener("input", function() {
    const linkedinValue = linkedinInput.value.replace(/ /g, "-");
    linkedinInput.value = linkedinValue;
  });

  const name = variables.name + " " + variables.lastName;
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://linkedin.com/in/${linkedinInput.value}"><i class="fab fa-linkedin"></i></a></li>
